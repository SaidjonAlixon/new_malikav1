        ...
        <div className="max-w-4xl mx-auto relative z-10 text-gray-300">
          ...
          <div className="prose prose-invert max-w-none space-y-6">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Qurilmangizga xizmat ko'rsatish bo'yicha aloqa o'rnatish</li>
            ...
            <ul className="list-none space-y-2">
              <li><strong>Manzil:</strong> Toshkent, Shayxontohur tumani, Malika Savdo Majmuasi, A-blok, 15-do'kon</li>
              <li><strong>Telefon:</strong> +998 33 999 03 33</li>
            </ul>
          </div>
        </div>
      </div>
