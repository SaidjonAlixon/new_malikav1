      ...
      <div className="pt-[120px] pb-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-gray-300">
          ...
          <div className="prose prose-invert max-w-none space-y-6">
            ...
            <p>
              Biz mobil qurilmalarga texnik xizmat ko'rsatish, ehtiyot qismlarini yangilash va dasturiy ta'minotni sozlash bo'yicha xizmatlar ko'rsatamiz. Veb-saytda keltirilgan narxlar va muddatlar taxminiy bo'lib, qurilmani bevosita ko'zdan kechirgandan so'ng yakuniy narx belgilanadi.
            </p>
