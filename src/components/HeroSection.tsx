          ...
          >
            ...
            <div className="max-w-3xl text-left relative z-10 pt-8 sm:pt-0 pb-4 sm:pb-8 mb-16 sm:mb-0 w-full sm:w-auto">
              ...
              <div className="relative z-10 flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-full sm:w-auto">
                ...
                {/* Secondary Button */}
                <a href="tel:+998339990333" className="group relative w-full sm:w-auto flex items-center justify-center gap-3 px-8 py-4 bg-black/40 sm:bg-white/[0.03] hover:bg-black/60 sm:hover:bg-white/[0.08] border border-white/20 sm:border-white/10 hover:border-white/30 sm:hover:border-white/20 text-white rounded-full font-bold text-[15px] sm:text-base transition-all duration-300 backdrop-blur-xl hover:shadow-[0_0_30px_-5px_rgba(255,255,255,0.1)] hover:-translate-y-1 cursor-pointer drop-shadow-xl">
