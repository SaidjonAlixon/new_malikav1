      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
            ...
            <a href="tel:+998339990333" className="flex-1 sm:flex-none flex items-center justify-center gap-2 bg-black/5 dark:bg-white/[0.05] hover:bg-black/10 dark:hover:bg-white/[0.1] border border-black/10 dark:border-white/10 text-gray-900 dark:text-white px-6 py-3 rounded-xl font-bold transition-all duration-300 hover:border-black/20 dark:hover:border-white/20 hover:-translate-y-0.5 text-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16 relative z-10">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="text-gray-800 dark:text-gray-300 text-base leading-relaxed font-semibold mb-8 max-w-sm transition-colors duration-500">
              {t("footer.desc")}
            </p>
            <div className="flex gap-4">
              <a href="https://t.me/malikaservis" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-2xl bg-black/5 dark:bg-white/[0.03] border border-black/10 dark:border-white/10 flex items-center justify-center text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-black/10 dark:hover:bg-white/[0.08] hover:border-black/20 dark:hover:border-white/20 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <a href="https://www.instagram.com/malikaservis_a18?igsh=cnMwbjBlMXpsN3px&utm_source=qr" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-2xl bg-black/5 dark:bg-white/[0.03] border border-black/10 dark:border-white/10 flex items-center justify-center text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-black/10 dark:hover:bg-white/[0.08] hover:border-black/20 dark:hover:border-white/20 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <a href="https://www.facebook.com/share/18Y1rVcnsU/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-2xl bg-black/5 dark:bg-white/[0.03] border border-black/10 dark:border-white/10 flex items-center justify-center text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-black/10 dark:hover:bg-white/[0.08] hover:border-black/20 dark:hover:border-white/20 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-6">
              <li className="flex items-center h-10"><a href="#xizmatlar" className="group text-gray-900 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-300 font-bold flex items-center hover:translate-x-1"><span className="w-0 h-[2px] bg-blue-600 dark:bg-blue-400 mr-0 transition-all duration-300 group-hover:w-2 group-hover:mr-2 rounded-full"></span>{t("nav.services")}</a></li>
              <li className="flex items-center h-10"><a href="#jarayon" className="group text-gray-900 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-300 font-bold flex items-center hover:translate-x-1"><span className="w-0 h-[2px] bg-blue-600 dark:bg-blue-400 mr-0 transition-all duration-300 group-hover:w-2 group-hover:mr-2 rounded-full"></span>{t("nav.process")}</a></li>
              <li className="flex items-center h-10"><a href="#sharhlar" className="group text-gray-900 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-300 font-bold flex items-center hover:translate-x-1"><span className="w-0 h-[2px] bg-blue-600 dark:bg-blue-400 mr-0 transition-all duration-300 group-hover:w-2 group-hover:mr-2 rounded-full"></span>{t("nav.testimonials")}</a></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-6">
              <li><Link href="/services/ekran" className="group h-10 text-gray-900 dark:text-gray-200 font-bold hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-300 cursor-pointer flex items-center hover:translate-x-1"><span className="w-0 h-[2px] bg-blue-600 dark:bg-blue-400 mr-0 transition-all duration-300 group-hover:w-2 group-hover:mr-2 rounded-full"></span>{t("services.s1.title")}</Link></li>
              <li><Link href="/services/batareya" className="group h-10 text-gray-900 dark:text-gray-200 font-bold hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-300 cursor-pointer flex items-center hover:translate-x-1"><span className="w-0 h-[2px] bg-blue-600 dark:bg-blue-400 mr-0 transition-all duration-300 group-hover:w-2 group-hover:mr-2 rounded-full"></span>{t("services.s2.title")}</Link></li>
              <li><Link href="/services/dasturiy-taminot" className="group h-10 text-gray-900 dark:text-gray-200 font-bold hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-300 cursor-pointer flex items-center hover:translate-x-1"><span className="w-0 h-[2px] bg-blue-600 dark:bg-blue-400 mr-0 transition-all duration-300 group-hover:w-2 group-hover:mr-2 rounded-full"></span>{t("services.s4.title")}</Link></li>
              <li><Link href="/services/plata-tamiri" className="group h-10 text-gray-900 dark:text-gray-200 font-bold hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-300 cursor-pointer flex items-center hover:translate-x-1"><span className="w-0 h-[2px] bg-blue-600 dark:bg-blue-400 mr-0 transition-all duration-300 group-hover:w-2 group-hover:mr-2 rounded-full"></span>{t("services.s5.title")}</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-3 lg:col-start-10">
            ...
            <div className="space-y-5 mb-8">
              <div className="flex items-center gap-4 group cursor-default">
                ...
                <span className="text-gray-900 dark:text-gray-200 text-[15px] font-bold group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-all duration-300 group-hover:translate-x-1">
                  {language === 'uz' ? 'Tez va sifatli xizmat' : language === 'ru' ? 'Быстро и качественно' : language === 'en' ? 'Fast and quality service' : 'Hızlı ve kaliteli hizmet'}
                </span>
              </div>
              <div className="flex items-center gap-4 group cursor-default">
                ...
                <span className="text-gray-900 dark:text-gray-200 text-[15px] font-bold group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-all duration-300 group-hover:translate-x-1">
              ...
              <div className="flex items-center gap-4 group cursor-default">
                ...
                <span className="text-gray-900 dark:text-gray-200 text-[15px] font-bold group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-all duration-300 group-hover:translate-x-1">
        ...
        {/* Bottom Bar */}
        <div className="pt-8 mt-12 relative flex flex-col lg:flex-row items-center lg:items-start justify-between gap-8 z-10 text-center lg:text-left">
          ...
          <div className="w-full lg:max-w-xl">
            <p className="text-gray-400 dark:text-gray-500 text-[11px] leading-relaxed">
              {language === 'uz' ? "Malika Servisi mustaqil texnik xizmat markazi bo'lib, hech qanday rasmiy brendlarning hamkori hisoblanmaydi. Saytda keltirilgan barcha savdo belgilari o'z egalariga tegishli." : 
               language === 'ru' ? "Malika Servisi является независимым сервисным центром и не является официальным партнером каких-либо брендов. Все торговые марки принадлежат их владельцам." : 
               language === 'en' ? "Malika Servisi is an independent service center and is not an official partner of any brands. All trademarks belong to their respective owners." : 
               "Malika Servisi bağımsız bir teknik servis merkezidir ve hiçbir markanın resmi ortağı değildir. Tüm ticari markalar ilgili sahiplerine aittir."}
            </p>
          </div>

          <div className="flex flex-col items-center lg:items-end gap-4 shrink-0">
            <div className="flex flex-wrap justify-center gap-6">
              <a href="/privacy" className="text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors text-sm font-medium">{t("footer.privacy")}</a>
              <a href="/terms" className="text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors text-sm font-medium">{t("footer.terms")}</a>
            </div>
