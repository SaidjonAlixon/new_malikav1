...
import { MapPin, Phone, Clock, Navigation, Send, ArrowUpRight, Mail } from "lucide-react";
          ...
          >
            <div className="relative p-8 sm:p-10 rounded-[2.5rem] bg-white/60 dark:bg-[#0a0a0a]/80 border border-black/5 dark:border-white/10 shadow-2xl dark:shadow-[0_0_50px_-20px_rgba(255,255,255,0.1)] backdrop-blur-2xl overflow-hidden group/card">
              ...
              <ul className="relative space-y-8">
                ...
                <li>
                  <a 
                    href="mailto:info@malikaservisi.uz" 
                    className="group flex items-start gap-5 hover:bg-black/5 dark:hover:bg-white/5 p-3 -m-3 rounded-2xl transition-all duration-300"
                  >
                    <div className="relative w-14 h-14 rounded-full bg-gradient-to-br from-red-500/10 to-red-600/10 text-red-600 dark:text-red-400 flex items-center justify-center shrink-0 shadow-sm border border-red-500/20 group-hover:bg-red-500 group-hover:text-white transition-all duration-500 group-hover:shadow-[0_0_20px_rgba(239,68,68,0.4)] group-hover:scale-110 overflow-hidden">
                      <div className="absolute inset-0 bg-gradient-to-br from-red-400 to-red-600 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                      <Mail className="w-6 h-6 relative z-10 transition-transform duration-500 group-hover:scale-110" />
                    </div>
                    <div className="flex flex-col justify-center pt-1">
                      <h4 className="text-xs font-black text-gray-400 dark:text-gray-500 mb-1.5 tracking-[0.2em] uppercase">{language === 'uz' ? 'Elektron pochta' : language === 'ru' ? 'Электронная почта' : language === 'en' ? 'Email' : 'E-posta'}</h4>
                      <p className="text-gray-900 dark:text-gray-200 font-bold leading-relaxed text-[15px] group-hover:text-red-600 dark:group-hover:text-red-400 transition-colors">
                        info@malikaservisi.uz
                      </p>
                    </div>
                  </a>
                </li>
